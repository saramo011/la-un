 ...
 */
class IcsLinearLayout2 extends LinearLayout {
    ...
    public IcsLinearLayout2(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(IcsLinearLayout2.LL_DIVIDER));
