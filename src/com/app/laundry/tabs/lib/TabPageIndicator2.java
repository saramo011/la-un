    ...
    private final OnClickListener mTabClickListener = new OnClickListener() {
        public void onClick(View view) {
           ...
           /* if(oldSelected==0)
            ...
            {
            	old_tab.setBackgroundResource(R.drawable.unselected_toprated);
            	//old_tab=tabView;
            } else if(oldSelected==3)
            {
            	old_tab.setBackgroundResource(R.drawable.unselected_favourite);
            	//old_tab=tabView;
            }else if(oldSelected==4)
            {
            	old_tab.setBackgroundResource(R.drawable.unselected_deals);
            	//old_tab=tabView;
            }
...
// showing selection
    ...
    public TabPageIndicator2(Context context, AttributeSet attrs) {
        ...
        mTabLayout = new IcsLinearLayout2(context, R.attr.vpiTabPageIndicatorStyleMyMusic);
...
*/        //old_tab=tabView;
    ...
    private class TabView extends TextView {
        ...
        public TabView(Context context) {
            super(context, null, R.attr.vpiTabPageIndicatorStyleMyMusic);
        }
