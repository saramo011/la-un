 ...
 */
public class LinePageIndicator2 extends View implements PageIndicator2 {
    ...
    public LinePageIndicator2(Context context) {
        this(context, null);
    }

    public LinePageIndicator2(Context context, AttributeSet attrs) {
    ...
    public LinePageIndicator2(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintUnselected.setColor(a.getColor(R.styleable.LinePageIndicator2_unselectedColor, defaultUnselectedColor));
